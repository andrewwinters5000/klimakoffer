...
EBMs were mainly used up to the 1970s, but later replaced more and more by the GCMs. Nowadays EBMs belong to the class of simple climate models, but
...
get an intuition about how they act. To quote the book by Kim and North (2017, Wiley) "Energy Balance Climate Models":
...
We will learn that EBMs (and to some extent all other models as well) depend on empirical parameters. The strength
