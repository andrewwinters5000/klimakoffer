...
def compute_transient_EBM_0D(mean_heat_capacity, mean_solar_forcing):
    ...
    for yr in range(1,years):
        ...
        for ts in range(ntimesteps):
            ...
            rhs_system = calc_rhs_system_backward_euler(delta_t,mean_heat_capacity,  mean_solar_forcing[ts_old], mean_solar_forcing[ts], annual_temperature[ts_old], co2_ppm = co2_data[yr])
