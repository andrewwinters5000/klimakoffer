...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.72\linewidth]{../../website/_assets/milestone_results/milestone2_albedo.png}
\caption{Plot of the albedo}
\end{figure}

\begin{figure}[!htb]
	\centering
\includegraphics[width=0.72\linewidth]{../../website/_assets/milestone_results/milestone2_heat_capacity.png}
\caption{Plot of the heat capacity}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=0.72\linewidth]{../../website/_assets/milestone_results/milestone2_solar_forcing_day_80.png}
