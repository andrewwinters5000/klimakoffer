...
\item[5.] What is the temperature in Link\"{o}ping according to the pointwise EBM? Compare it to the other results. What is noticeable?
...
\begin{figure}[!htb]
\includegraphics[width=0.6\linewidth,center]{../../website/_assets/milestone_results/milestone4_mean.png}
\caption{EBM results for the mean temperatures}
\end{figure}

\begin{figure}[!htb]
\includegraphics[width=0.6\linewidth,center]{../../website/_assets/milestone_results/milestone4_pointwise.png}
\caption{EBM results for the mean temperature based on the pointwise calculations}
\end{figure}

\begin{figure}[!htb]
\includegraphics[width=0.6\linewidth,center]{../../website/_assets/milestone_results/milestone4_linkoping.png}
\caption{pointwise EBM results}
\end{figure}

\begin{figure}[!htb]
\includegraphics[width=0.7\linewidth,center]{../../website/_assets/milestone_results/milestone4_temperature_day_80.png}
