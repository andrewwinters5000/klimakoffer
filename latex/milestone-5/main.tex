...
\item[5.] Examine the sparsity pattern of the Jacobian matrix. What does the matrix look like? Be aware that \texttt{spy} of Plots.jl can be very slow for large matrices when using the PythonPlot backend. If you want to examine the whole Jacobian, use the GR backend instead.
...
\begin{figure}[!htb]
\includegraphics[width=0.6\linewidth,center]{../../website/_assets/milestone_results/milestone5_diffusion_coeff.png}
\caption{Diffusion coefficients}
\end{figure}

\begin{figure}[!htb]
\includegraphics[width=0.6\linewidth,center]{../../website/_assets/milestone_results/milestone5_jacobian.png}
\caption{Sparsity pattern of the upper left part of the system matrix}
\end{figure}

\begin{figure}[!htb]
\includegraphics[width=0.6\linewidth,center]{../../website/_assets/milestone_results/milestone5_jacobian_row_major.png}
\caption{Sparsity pattern of the upper left part of the system matrix in a row-major language like Python}
\end{figure}
